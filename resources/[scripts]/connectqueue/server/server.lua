...
Config.Language = {
    ...
    banned = "You are banned, you may appeal it at www.bluelinegaming.net | Reason: %s",
    steam = "Error: Steam must be running",
    prio = "You must be whitelisted to join this server. You may apply at www.bluelinegaming.net"
}
-----------------------------------------------------------------------------------------------------------------------
